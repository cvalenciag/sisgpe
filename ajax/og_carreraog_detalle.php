...
$q_admin = $conn->query("select objgeneral.idObjgeneral,objgeneral.definicion,objgeneral.idCompetencia from objgeneral $sWhere") or die(mysqli_error($conn));
			...
			/*	while ($row=mysqli_fetch_array($query)){*/
					...
					$sql=$conn->query("select * from detalle_carrera_og where idObjgeneral= '" .$idObjgeneral . "' and idCarrera= '" .$idCarrera . "' and idCarreraOg='".$idCarreraOg."'");
 ...
 <script src = "https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    ...
    /*$('.msj').hide();*/
     ...
     $("#table2").on("click", "#agregaCO", function(){
        ...
        data: "idOg="+id+"&ordenamiento="+ordenamiento+"&idCa="+idCarrera+"&idCarreraOg="+idCarreraOg+"&idCompetencia="+idCompetencia+"&op=I",
