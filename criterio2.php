...
<html lang = "eng">
	<?php require("head.php"); ?>
		<div class = "container-fluid">
			...
			<div class = "col-lg-9 well" style = "margin-top:110px;background-color:#fefefe;">
				<div class = "alert alert-jcr">Rúbricas / Criterio de evaluación y sus niveles de desempeño</div>
							...
							?>
								<tr class = "target">
									...
									<td class="text-center">
										<button type="button" class="btn btn-sm btn-primary" id="<?php echo $f_admin['idCriterio'] ?>" onclick="showModalNiveles(this.id);">
		                  <!-- <span class="glyphicon glyphicon-search"></span> Agregar <br> Niveles -->
											<span class="glyphicon glyphicon-floppy-saved" title="Agregar Niveles"></span>
		                </button>
									</td>
						...
						<div class = "col-lg-6">
							<form id = "formCriterio" method = "POST" action = "criterioGrabar.php" enctype = "multipart/form-data">
								...
								<div class = "form-group">
									...
									<textarea id="desCriterio" required="required" rows="6" name="descripcion" class="form-control"></textarea>
								</div>

								<div class = "form-group">
									<label>Definición:</label>
									<textarea id="defCriterio" required="required" rows="6" name="definicion" class="form-control"></textarea>
								</div>
								...
								<!-- <div class="form-group">
	                <button type="button" class="btn btn-default" id="addNiveles" onclick="showModalNiveles();">
	                  <span class="glyphicon glyphicon-search"></span> Agregar Niveles
	                </button>
	              </div> -->

								<div class = "form-group">
									<button class="btn btn-primary" name="save_user">
		...
		<div class="modal fade" id="modalAddNiveles" role="dialog" tabindex="-2"></div>
		<br />
		<br />
		<br />
	...
	<script type="text/javascript">
	function showModalNiveles(xIdCriterio){

		// alert(xIdCriterio);
		// xDesCriterio = $('#desCriterio').val();

		// if(edit==2){
		// 	urlModalNiveles = './modal/modalAddNiveles.php?editar='+edit+'&idGrupoAlum='+idGrupoAlum;
		// }else {
			urlModalNiveles = './modal/modalAddNiveles.php?idCriterio='+xIdCriterio;
		// }


		$.get(urlModalNiveles, function(data){
			$('#modalAddNiveles').html(data).modal();
		})
	}
	</script>
</html>
