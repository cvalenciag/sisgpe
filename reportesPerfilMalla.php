	...
	<?php require("head2.php"); ?>
		<div class = "container-fluid">
			...
			<div class = "col-lg-9 well" style="margin-top:110px;background-color:#fefefe;">
				<div class = "alert alert-jcr">Reportes / Perfil de egreso</div>
					...
					<div id="admin_table">
						<div class="col-lg-12" align="center">
							<h3><b><u>Reporte de Perfil de egreso</u></b></h3>
						</div>

						<div class="col-md-4" style="margin-top:25px;">
							<div class="form-group">
								<label>Facultad:</label><br/>
									<select name="idFacultad" id="idFacultadPerfil" required="required" class="form-control" style="width:250px;">
						...
						<div class="col-md-4" style="margin-top:25px;">
							<div class="form-group">
								<label>Carrera:</label><br/>
									<select name="idCarrera" id="idCarreraPerfil" required="required" class="form-control" style="width:250px;">
										<option value="" selected="selected">Seleccione una opción</option>
									</select>
							</div>
						</div>
						...
						<div class="col-md-4" style="margin-top:25px;">
							<div class = "form-group">
								<label>Fecha de Perfil de egreso:</label><br/>
									<select name="fechaMP" id="fechaPerfil" required="required" class="form-control" style="width:250px;">
										<option value="" selected="selected">Seleccione una opción</option>
									</select>
							</div>
						</div>
						...
						<!-- <div class="col-md-3" style="margin-top:25px;">
							<div class = "form-group">
								<label>Cursos Obligatorios:</label><br/>
									<select name="obligatorio" id="idObligaMP" required="required" class="form-control" style="width:250px;">
										<option value="" selected="selected">Seleccione una opción</option>
            ...
            <div class="col-lg-12" align="center" style="margin-top:25px;">
							<button id="" type="button" class="btn btn-primary" style="width:250px; height:35px" onclick="generaReportePerfil();">
          ...
          <div id="resultadosPerfil" class='col-md-12'></div>
