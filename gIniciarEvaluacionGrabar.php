...
if($option == 'upOral')
{
  ...
  foreach ($qrySubCriterios as $subCri)
  {
    ...
    if($puntaje>=$valMinimo && $puntaje<=$valMaximo)
    {
      ...
      $conn->query("UPDATE detalle_evaluacion SET puntajeEvaluador='$puntaje', idNivel='$nivel' WHERE idEvaluacion='$idEvaluacion' AND idRubrica='$idRubrica' AND idAlumno='$idAlumno' AND idEvaluador='$idEvaluador'") or die(mysqli_error($conn));
