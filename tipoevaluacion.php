...
<html lang = "eng">
	<?php require("head.php"); ?>
		<div class = "container-fluid">
			...
			<div class = "col-lg-9 well" style = "margin-top:110px;background-color:#fefefe;">
				<div class = "alert alert-jcr">Evaluaciones / Tipo de evaluación</div>
					...
					<label>Descargar</label>
						<table id = "table" class = "table table-bordered table-hover" style="width:100%">
							...
							if($_SESSION['rol_id']==1)
                                                        ...
                                                        $rol=" where estado=1";
								$q_admin = $conn->query("SELECT * FROM `tipo_evaluacion`".$rol) or die(mysqli_error($conn));
 ...
 <a href = "#" class = "btn btn-editar eadmin_id" value = "<?php echo $f_admin['idTipoEval']?>">
                                                                        <span class = "glyphicon glyphicon-edit" title="Editar registro"></span> </a>
									<a href = "#" class = "btn <?php echo $btnclas?> deladmin_id" value = "<?php echo $f_admin['idTipoEval'].'&estado='.$estado?>">
					...
					<div id = "admin_form" style = "display:none;">
						...
						<div class = "col-lg-6">
							<form id = "formtipoevaluacion" method = "POST" action = "tipoevaluacionGrabar.php" enctype = "multipart/form-data">
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$("#table").on("click", ".deladmin_id", function(){
				...
				setTimeout(function(){
					window.location = 'tipoevaluacionEliminar.php?admin_id=' + $admin_id;
				}, 1000);
			});
			$("#table").on("click", ".eadmin_id", function(){
				...
				$('#admin_table').fadeOut();
				$('#add_admin').hide();
				$('#edit_form').load('tipoevaluacionCargar.php?admin_id=' + $admin_id);
			});
		});
	</script>
</html>