...
$conn->query("UPDATE subcriterio SET idNivel='$idNivel', descripcion='$descNivel', rango='$rango', total='$punTotal', minimo='$punMin', maximo='$punMax', peso='$peso' WHERE idCriterio='$idCriterio' AND idSubcriterio='$idSubCrite'") or die(mysqli_error($conn));
